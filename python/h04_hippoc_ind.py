"""
computes the FC (4096, 360) of hippocampus-to-cortex, separate for L & R hems.
usage: $ python h04_hippoc_ind.py HCP_100610
"""
...
# zeros array for hippocampus-to-cortex correlation matrix
