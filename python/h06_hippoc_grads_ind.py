"""
computes and aligns individual-level gradients to their subfield group-level grads.
usage: $ python h06_hippoc_grads_ind.py HCP_165840 LSUB
"""
...
if roi == 'RSUB' or roi == 'RCA' or roi == 'RDG':
    ...
    with h5py.File(group_gradient_file, 'r') as g:
        group_gradients = np.array(g['gradients_'])  # (4096, 10)
    print('Right: We had computed group-level gradients : ', group_gradients.shape)  
